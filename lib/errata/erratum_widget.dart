    ...
    return Column(
      children: [
        ExpansionTile(
          ...
          title: Text(widget.model.name, style: context.textTheme.titleMedium),
          subtitle: Text(widget.model.set, style: context.textTheme.bodyMedium),
          children: [
            Column(
                      ...
                      children: [
                        if (widget.model.set != "UNL")
                          Container(
                            ...
                            child: Padding(
                                padding:
                                    EdgeInsetsGeometry.fromLTRB(12, 5, 12, 5),
                                child: Row(
                                    mainAxisAlignment:
