...
class AboutView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Uri githubUri =
        Uri.parse('https://github.com/Villawhatever/pocket-judge');
    final Uri discordUri =
        Uri.parse('https://discord.com/channels/@me/49416803398455296');
    ...
    return AppWrapper(
        ...
        body: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text(
              'This app is not produced by or affiliated with Riot Games, Riftbound, Tencent, or any related entities. All card images remain the copyright of Riot Games. All rules, guides, card information, etc are published by Riot Games.')
        ]));
  }
}
